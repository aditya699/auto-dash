...
def create_app(df):
    ...
    def update_dashboard(departments, start_date, end_date, salary_selection, department_click, age_selection, gender_click, reset_clicks):
        ...
        gender_diversity = len(dff[dff['gender'] == 'Female']) / total_employees * 100
        ...
        past_gender_diversity = len(past_dff[past_dff['gender'] == 'Female']) / past_total_employees * 100
        ...
        diversity_change = gender_diversity - past_gender_diversity
        ...
        kpi_indicators = html.Div([
            ...
            create_kpi_card('Gender Diversity (%)', gender_diversity, diversity_change)
        ...
        age_distribution = px.histogram(dff, x=(datetime.now() - dff['date_of_birth']).astype('<m8[Y]'), nbins=20, title="Age Distribution",
