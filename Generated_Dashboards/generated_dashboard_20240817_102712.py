...
def create_app(df):
    ...
    def update_dashboard(departments, start_date, end_date, salary_selection, gender_click, job_title_click, age_selection, reset_clicks):
        ...
        return kpi_indicators, salary_distribution, gender_distribution, job_title_distribution, age_distribution    
