            ...
            html.Div([
                html.Div([
                    ...
                    dcc.Dropdown(
                        ...
                        options=[{'label': 'Select All', 'value': 'all'}] + [{'label': i, 'value': i} for i in df.department.unique()],
                        value=['all'],
                        multi=True,
                        style={'width': '300px'}
                    )
    ...
    def update_dashboard(departments, start_date, end_date, salary_selection, department_click, gender_click, age_selection, reset_clicks):
        ...
        if ctx.triggered:
            ...
            if input_id == 'reset-button':
                dff = df[(df.hire_date >= start_date) & (df.hire_date <= end_date)]
        ...
        gender_ratio = dff['gender'].value_counts(normalize=True)['Male'] if 'Male' in dff['gender'].unique() else 0
